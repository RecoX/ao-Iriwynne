...
Begin VB.Form frmMain 
   ...
   Caption         =   "WorldEditor - Iriwynne AO"
   ClientHeight    =   10740
   ClientLeft      =   390
   ClientTop       =   840
   ClientWidth     =   16185
   ...
   Begin VB.PictureBox pPaneles 
      ...
      Begin VB.ComboBox cCapas 
         ...
         ForeColor       =   &H80000014&
         Height          =   330
         ItemData        =   "frmMain.frx":20E58
         Left            =   1080
         List            =   "frmMain.frx":20E68
         TabIndex        =   1
         TabStop         =   0   'False
         Text            =   "1"
         Top             =   3120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   0
         ItemData        =   "frmMain.frx":20E78
         Left            =   120
         List            =   "frmMain.frx":20E7A
         Sorted          =   -1  'True
         TabIndex        =   71
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":20E7C
         Left            =   3360
         List            =   "frmMain.frx":20E7E
         TabIndex        =   67
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":20E80
         Left            =   840
         List            =   "frmMain.frx":20E82
         TabIndex        =   0
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   3
         ItemData        =   "frmMain.frx":20E84
         Left            =   120
         List            =   "frmMain.frx":20E86
         TabIndex        =   66
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":20E88
         Left            =   840
         List            =   "frmMain.frx":20E8A
         TabIndex        =   58
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":20E8C
         Left            =   3360
         List            =   "frmMain.frx":20E8E
         TabIndex        =   57
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   1
         ItemData        =   "frmMain.frx":20E90
         Left            =   120
         List            =   "frmMain.frx":20E92
         TabIndex        =   55
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   3210
         Index           =   4
         ItemData        =   "frmMain.frx":20E94
         Left            =   120
         List            =   "frmMain.frx":20E96
         TabIndex        =   54
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":20E98
         Left            =   840
         List            =   "frmMain.frx":20E9A
         TabIndex        =   77
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   2
         ItemData        =   "frmMain.frx":20E9C
         Left            =   120
         List            =   "frmMain.frx":20E9E
         TabIndex        =   79
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":20EA0
         Left            =   3360
         List            =   "frmMain.frx":20EA2
         TabIndex        =   80
         Text            =   "500"
         Top             =   3120
         Visible         =   0   'False
...
Private Sub Command1_Click(Index As Integer)
    ...
    If Trigger.Text > 6 Then
        MsgBox "La concha de tu hermana concentratee! Maximo de triggers 6"
        Exit Sub
    End If
    ...
    For y = YMinMapSize To YMaxMapSize
        For X = XMinMapSize To XMaxMapSize
            ...
            MapData(X, y).Trigger = Trigger.Text
...
Private Sub Command2_Click(Index As Integer)
    ...
    If TextTrigger.Text > 4 Then
        MsgBox "La concha de tu hermana concentratee! Maximo de capas 4."
        Exit Sub
    End If

    If TextCaca.Text > 6 Then
        MsgBox "La concha de tu hermana concentratee! Maximo de triggers 6."
        Exit Sub
    End If
    ...
    For X = 8 To 92    'recorremos, all the mapitax
        For y = 10 To 92
            ...
            If MapData(X, y).Graphic(TextTrigger.Text).GrhIndex <> 0 Then    'si el grh de la capa 4 es diferente a 0
                MapInfo.Changed = 1    'Set changed flag
                MapData(X, y).Trigger = TextCaca.Text    'seteamos el trigger
            End If

        Next y
    Next X

    MsgBox "La capa ha sido triggereada perfestamente gg."
End Sub

Private Sub Command3_Click()

    If TextCapas.Text > 4 Then
        MsgBox "La concha de tu hermana concentratee! Maximo de capas 4"
        Exit Sub
    End If
    ...
    For X = 9 To 92
        For y = 7 To 94
            ...
            If MapData(X, y).Graphic(TextCapas.Text).GrhIndex <> 0 Then
                MapInfo.Changed = 1
                MapData(X, y).Blocked = 1
            End If
    ...
    MsgBox "El mapa ha sido bloqueado correctamente."
End Sub
