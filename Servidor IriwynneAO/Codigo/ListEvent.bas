...
Public Sub Start_List(ByVal UserIndex As Integer, ByVal Amount As Byte)
    ...
    With List
        ...
        If Not esGM(UserIndex) Then
            Call WriteConsoleMsg(UserIndex, "Tienes que ser GM para hacer esta operaci�n.", FontTypeNames.FONTTYPE_INFOBOLD)
            Exit Sub
        End If
...
Public Sub Access_List(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        If .flags.Muerto = 1 Then
            Call WriteConsoleMsg(UserIndex, "��Est�s muerto!!", FontTypeNames.FONTTYPE_INFOBOLD)
            Exit Sub
        End If
       ...
       ' End If
        ...
        If .flags.List <> 0 Then
            Call WriteConsoleMsg(UserIndex, "Ya est�s en la lista!", FontTypeNames.FONTTYPE_INFOBOLD)
            Exit Sub
        End If
        ...
        '@@ Le damos el flag para que est� en lista
        .flags.List = 1
