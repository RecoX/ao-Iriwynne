...
Private Const TIEMPO_PASAR_RANDOM As Integer = 2 'Tiempo m�ximo para el random para que el centinela vuelva a pasar
                    ...
                    .Counters.LastCentinela = tmpTick
                                        ...
                                        With Centinela(CentinelaIndex)
                                                ...
                                                If .NpcIndex <> 0 Then
                                                        ...
                                                        Call WriteChatOverHead(LoopC, "Saludos " & UserList(LoopC).Name & ", soy el Centinela de estas tierras. Me gustar�a que escribas /CENTINELA " & .clave & " en no m�s de 60 segundos.", CStr(Npclist(.NpcIndex).Char.CharIndex), vbGreen)
...
99                  Call WriteChatOverHead(Userindex, "�" & UserList(Userindex).Name & ", tienes un minuto m�s para responder! Debes escribir /CENTINELA " & .clave & ".", CStr(Npclist(.NpcIndex).Char.CharIndex), vbRed)
98                  Call WriteConsoleMsg(Userindex, "�" & UserList(Userindex).Name & ", tienes un minuto m�s para responder!", FontTypeNames.FONTTYPE_CENTINELA)
