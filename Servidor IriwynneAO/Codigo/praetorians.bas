...
'    NpcIndex = CrearNPC(PRKING_NPC, Configuracion.MAPA_PRETORIANO, wp2)
'
...
'    wp.X = wp.X + 3
'    Call ClosestLegalPos(wp, wp2, False, True)
'    NpcIndex = CrearNPC(PRCLER_NPC, Configuracion.MAPA_PRETORIANO, wp2)
'
'    PretoIndex = PretoIndex + 1
'    Pretorianos(PretoIndex) = NpcIndex
'
...
'    wp.Y = wp.Y + 3
'    Call ClosestLegalPos(wp, wp2, False, True)
'    NpcIndex = CrearNPC(PRGUER_NPC, Configuracion.MAPA_PRETORIANO, wp2)
'
'    PretoIndex = PretoIndex + 1
'    Pretorianos(PretoIndex) = NpcIndex
'
...
'    wp.X = wp.X - 1
'    Call ClosestLegalPos(wp, wp2, False, True)
'    NpcIndex = CrearNPC(PRCAZA_NPC, Configuracion.MAPA_PRETORIANO, wp2)
'
'    PretoIndex = PretoIndex + 1
'    Pretorianos(PretoIndex) = NpcIndex
'ErrHandler:
...
'
'        If Not NPCPosM = Configuracion.MAPA_PRETORIANO Then Exit Sub
'
