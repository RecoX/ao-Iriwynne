...
errhandleR:
    ...
    LogError "Error en ApagarServer en linea " & Erl & " - " & Err.Number & " " & Err.description
...
Private Sub cmdIntervalos_Click()
        ...
        Call MsgBox("Intervalos Recargados Correctamente", , "Iriwynne AO")

End Sub

Private Sub cmdExperiencia_Click()
        Call CargarExperiencia
        Call MsgBox("Experiencia Recargada Correctamente", , "Iriwynne AO")

End Sub

Private Sub cmdConfiguracionIni_Click()
        Call CargarConfiguracionHAO
        Call MsgBox("Configuracion Recargada Correctamente", , "Iriwynne AO")

End Sub

Private Sub cmdMensajes_Click()
        Call CargarMsgs
        Call MsgBox("Mensajes Recargados Correctamente", , "Iriwynne AO")

End Sub

Private Sub cmdCanjes_Click()
        Call LoadCanjesData
        Call MsgBox("Canjes Recargados Correctamente", , "Iriwynne AO")
