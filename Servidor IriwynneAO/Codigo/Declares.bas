...
Public CountdownMap As Integer

'********** Constantes de da�o.
Public Const DAMAGE_PU�AL    As Byte = 1
...
' @@ Miqueas : Por ahora desactivados - 04/12/15
...
Public Const LAUDSHOP            As Integer = 1139

Public Const FLAUTASHOP            As Integer = 1140
...
' @param ZONAOSCURA lo que haya en este trigger no ser� visible
...
Public Const MAX_ORO_EDIT                   As Long = 15000000
...
Public Const MAXNPCS  As Integer = 32000

Public Const MAXCHARS As Integer = 32000
...
Public Type Inventario
        ...
        Object(1 To MAX_NORMAL_INVENTORY_SLOTS) As UserOBJ
...
Public Type ObjData
        ...
        Cofres As e_Reward ' @@ Items Shop - Cofres
        ObjNoCreable As Byte
...
Public Type tQuest    ' Configuraci�n de la Quest
    Nombre As String
    desc As String
...
RequiredKills As Integer
    ...
    YaPediAyuda As Boolean
    YaPediAyudaCount As Integer
    Vip As Byte
    ...
    Lemande As String
        ...
        LastNPCTalk As Integer ' sagarius
        MenuCliente As Byte ' @@ Miqueas : Seguridad
        LastSlotClient As Byte ' @@ Miqueas : Seguridad
...
Public Type User
        ...
        InvSuma As Byte ' @@ Usado para los Cofres
...
'Modificador de defensa para armaduras de segunda jerarqu�a.
