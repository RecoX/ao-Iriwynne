...
Private Sub Form_Load()
        ...
        Me.Picture = LoadPicture(DirInterfaces & "VentanaConfigurarTeclas.jpg")
...
Private Sub LoadButtons()
        ...
        Call cBotonGuardar.Initialize(imgGuardar, grhpath & "buttons/boton Guardar y salir.jpg", grhpath & "buttons/boton Guardar y salir 1.jpg", grhpath & "Buttons/boton Guardar y salir 1.jpg", Me)

        Call cBotonDefaultKeys.Initialize(imgDefaultKeys, grhpath & "Buttons/boton Cargar teclas por defecto.jpg", grhpath & "Buttons/boton Cargar teclas por defecto 1.jpg", grhpath & "Buttons/boton Cargar teclas por defecto 1.jpg", Me)
...
Private Sub Text1_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)
        ...
        For i = 1 To CustomKeys.Count
                ...
                If i <> Index Then
                        If CustomKeys.BindedKey(i) = KeyCode Then ' @@ HAO - 21/08/2015
