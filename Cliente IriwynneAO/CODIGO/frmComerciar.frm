...
Begin VB.Form frmComerciar 
   ...
   Begin VB.Image imgCross 
      Height          =   210
      Left            =   6600
      MouseIcon       =   "frmComerciar.frx":10BBE
      MousePointer    =   99  'Custom
      Picture         =   "frmComerciar.frx":10EC8
      Tag             =   "1"
      Top             =   120
      Width           =   195
   End
   Begin VB.Image imgVender 
      Height          =   465
      Left            =   4080
      MouseIcon       =   "frmComerciar.frx":16F7A
      MousePointer    =   99  'Custom
      Tag             =   "1"
      Top             =   6000
      Width           =   2340
   ...
   Begin VB.Image imgComprar 
      Height          =   465
      Left            =   510
      MouseIcon       =   "frmComerciar.frx":170CC
      MousePointer    =   99  'Custom
      Tag             =   "1"
      Top             =   6030
      Width           =   2580
...
Private Sub LoadButtons()
        ...
        Call cBotonVender.Initialize(imgVender, grhpath & "boton vender.bmp", _
           grhpath & "boton vender 1.bmp", _
           grhpath & "boton vender 1.bmp", Me)

        Call cBotonComprar.Initialize(imgComprar, grhpath & "boton comprar.bmp", _
           grhpath & "boton comprar 1.bmp", _
           grhpath & "boton comprar 1.bmp", Me)
...
Private Function CalculateSellPrice(ByRef objValue As Single, _
        ...
        Exit Function
error:
        If CalculateSellPrice = 0 Then
        CalculateSellPrice = 999999999#
        End If
...
Private Sub picInvNpc_Click()
    ...
    Label1(1).Caption = "Valor en copas : " & NPCInventory(ItemSlot).Copas
    Else
