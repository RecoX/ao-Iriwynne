...
Private Sub CargarImagenes()
        ...
        Call cPicCerrar.Initialize(imgCerrar, ImgPath & "Buttons/boton Cerrar.bmp", ImgPath & "Buttons/boton Cerrar 1.bmp", ImgPath & "Buttons/boton Cerrar 1.bmp", Me)
        
        Call cPicConstruir(0).Initialize(picConstruir0, ImgPath & "Buttons/boton Construir.bmp", ImgPath & "Buttons/boton Construir 1.bmp", ImgPath & "Buttons/boton Construir 1.bmp", Me)
        Call cPicConstruir(1).Initialize(picConstruir1, ImgPath & "Buttons/boton Construir.bmp", ImgPath & "Buttons/boton Construir 1.bmp", ImgPath & "Buttons/boton Construir 1.bmp", Me)
        Call cPicConstruir(2).Initialize(picConstruir2, ImgPath & "Buttons/boton Construir.bmp", ImgPath & "Buttons/boton Construir 1.bmp", ImgPath & "Buttons/boton Construir 1.bmp", Me)
        Call cPicConstruir(3).Initialize(picConstruir3, ImgPath & "Buttons/boton Construir.bmp", ImgPath & "Buttons/boton Construir 1.bmp", ImgPath & "Buttons/boton Construir 1.bmp", Me)
        
        Call cPicMejorar(0).Initialize(picMejorar0, ImgPath & "Buttons/boton Construir.bmp", ImgPath & "Buttons/boton Construir 1.bmp", ImgPath & "Buttons/Boton Construir 1.bmp", Me)
        Call cPicMejorar(1).Initialize(picMejorar1, ImgPath & "Buttons/boton Construir.bmp", ImgPath & "Buttons/boton Construir 1.bmp", ImgPath & "Buttons/Boton Construir 1.bmp", Me)
        Call cPicMejorar(2).Initialize(picMejorar2, ImgPath & "Buttons/boton Construir.bmp", ImgPath & "Buttons/boton Construir 1.bmp", ImgPath & "Buttons/Boton Construir 1.bmp", Me)
        Call cPicMejorar(3).Initialize(picMejorar3, ImgPath & "Buttons/boton Construir.bmp", ImgPath & "Buttons/boton Construir 1.bmp", ImgPath & "Buttons/Boton Construir 1.bmp", Me)

        imgCantidadCiclo.Picture = LoadPicture(ImgPath & "Buttons/boton construir por ciclo.jpg")
...
Private Sub Form_Load()
        ...
        MaxConstItem = IIf(UserClase = eClass.Worker, 10, 1)
