...
Private Sub LoadButtons()
        ...
        Call cBotonConstruir(0).Initialize(imgConstruir0, grhpath & "Buttons/Boton Construir.bmp", _
           grhpath & "Buttons/Boton Construir 1.bmp", _
           grhpath & "Buttons/Boton Construir 1.bmp", Me)
                                    
        Call cBotonConstruir(1).Initialize(imgConstruir1, grhpath & "Buttons/Boton Construir.bmp", _
           grhpath & "Buttons/Boton Construir 1.bmp", _
           grhpath & "Buttons/Boton Construir 1.bmp", Me)
                                    
        Call cBotonConstruir(2).Initialize(imgConstruir2, grhpath & "Buttons/Boton Construir.bmp", _
           grhpath & "Buttons/Boton Construir 1.bmp", _
           grhpath & "Buttons/Boton Construir 1.bmp", Me)
                                    
        Call cBotonConstruir(3).Initialize(imgConstruir3, grhpath & "Buttons/Boton Construir.bmp", _
           grhpath & "Buttons/Boton Construir 1.bmp", _
           grhpath & "Buttons/Boton Construir 1.bmp", Me)
    
        Call cBotonMejorar(0).Initialize(imgMejorar0, grhpath & "Buttons/Boton Mejorar.bmp", _
           grhpath & "Buttons/Boton Mejorar 1.bmp", _
           grhpath & "Buttons/Boton Mejorar 1.bmp", Me)
    
        Call cBotonMejorar(1).Initialize(imgMejorar1, grhpath & "Buttons/Boton Mejorar.bmp", _
           grhpath & "Buttons/Boton Mejorar 1.bmp", _
           grhpath & "Buttons/Boton Mejorar 1.bmp", Me)
    
        Call cBotonMejorar(2).Initialize(imgMejorar2, grhpath & "Buttons/Boton Mejorar.bmp", _
           grhpath & "Buttons/Boton Mejorar 1.bmp", _
           grhpath & "Buttons/Boton Mejorar 1.bmp", Me)
    
        Call cBotonMejorar(3).Initialize(imgMejorar3, grhpath & "Buttons/Boton Mejorar.bmp", _
           grhpath & "Buttons/Boton Mejorar 1.bmp", _
           grhpath & "Buttons/Boton Mejorar 1.bmp", Me)
                                    
        imgCantidadCiclo.Picture = LoadPicture(grhpath & "Buttons/Boton Construir por Ciclo.jpg")
