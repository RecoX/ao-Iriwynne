...
Begin VB.Form frmMapa 
   ...
   Begin VB.Label lblMapa 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   "Pasa por el mouse para obtener informaci�n acerca del mapa."
      ForeColor       =   &H00FFFFFF&
      Height          =   255
      Left            =   0
      TabIndex        =   1
...
Private Const lblMapaInfoCaption As String = "Informaci�n del mapa: "
...
Case 1
lblMapaInfo.Caption = lblMapaInfoCaption & "Ciudad principal. Ning�n bando r�ge sobre �stas tierras."
lblMapa.Caption = lblMapaCaption & "Ullathorpe"
Case 2
lblMapaInfo.Caption = lblMapaInfoCaption & "Ciudad segura reg�da por la Armada Real"
lblMapa.Caption = lblMapaCaption & "Nix"
Case 3
lblMapaInfo.Caption = lblMapaInfoCaption & "Ciudad segura reg�da por la Armada Real"
lblMapa.Caption = lblMapaCaption & "Banderbille"
Case 4
lblMapaInfo.Caption = lblMapaInfoCaption & "Ciudad insegura reg�da por los Criminales"
...
Case 32
lblMapaInfo.Caption = lblMapaInfoCaption & "Dungeon inseguro, hay: Liche, Zombie, Orco, Ara�a Gigante, Demonio"
lblMapa.Caption = lblMapaCaption & "Dungeon Marabel"
Case 34
lblMapaInfo.Caption = lblMapaInfoCaption & "Dungeon inseguro, hay: NPCs acu�ticos"
...
Case 43
lblMapaInfo.Caption = lblMapaInfoCaption & "Mapa inseguro, ideal para clases no m�gicas."
lblMapa.Caption = lblMapaCaption & "Monta�a enana"
Case 46
lblMapaInfo.Caption = lblMapaInfoCaption & "Mapa inseguro, hay �rboles �lficos."
lblMapa.Caption = lblMapaCaption & "Bosque �lfico"
Case 42
