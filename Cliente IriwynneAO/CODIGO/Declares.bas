...
Public CualPedi As Byte

Public MiError As String
Public Type tList
    AmountList  As Byte
    Names()     As String
    Indexs      As Byte
...
Public Type tAyudaClan
    Linea As String
    Active As Boolean
End Type

Public AyudaClan() As tAyudaClan

Public SegundosInvisible As Integer
...
Public AyudaClanMax As Byte
Public AyudaClanActive As Boolean
