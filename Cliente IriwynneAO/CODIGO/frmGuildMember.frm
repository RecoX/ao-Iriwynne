...
Private Sub imgDetalles_Click()
        ...
        Dim tmpn As String
        tmpn = lstClanes.List(lstClanes.listIndex)
        tmpn = Left(lstClanes.List(lstClanes.listIndex), InStr(1, lstClanes.List(lstClanes.listIndex), "[", vbTextCompare) - 2)
        Call WriteGuildRequestDetails(tmpn)
End Sub
