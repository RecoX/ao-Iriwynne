...
'***************************************************
    ...
    If Left$(Comando, 1) = "/" Then
        ...
        Case "/INFOQUEST"    ' GSZAO
            Call WriteQuestLists
            ...
            Case "/VERCPUID"    '//Disco.
                If esGM(UserCharIndex) Then
                    ...
                    Else
                        Call ShowConsoleMsg("Faltan par�metros. Utilice /vercpuid NICKNAME.")
                    End If
                End If
            ...
            Case "/FIANZA"    '//Disco.
                    ...
                    If notNullArguments Then
                        If ValidNumber(ArgumentosRaw, ent_Long) Then
                            Call WriteFianza(ArgumentosRaw)
                        Else
                            Call ShowConsoleMsg("Elije una cantidad m�s peque�a.")
                        End If
                    Else
                        Call ShowConsoleMsg("Faltan par�metros. Utilice /FIANZA CANTIDAD")
                    End If
                

            Case "/BANT0"
                If notNullArguments Then
                    If esGM(UserCharIndex) Then Call WriteBanT0(ArgumentosRaw)
                Else
                    Call ShowConsoleMsg("Faltan par�metros. Utilice /banT0 NICKNAME.")
                End If

            Case "/UNBANT0"
                If notNullArguments Then
                    If esGM(UserCharIndex) Then Call WriteUnBanT0(ArgumentosRaw)
                Else
                    Call ShowConsoleMsg("Faltan par�metros. Utilice /unbanT0 NroCPU_ID.")
                End If
        ...
        Case "/VIP"
           ...
           Dim asd() As String
           asd = Split(ArgumentosRaw, "@")
            If UBound(asd) >= 2 Then
'ArgumentosAll(1) = Replace(ArgumentosAll(1), "+", " ")
                If Len(ArgumentosRaw) > 1 Then
                    If ValidNumber(asd(1), eNumber_Types.ent_integer) And ValidNumber(asd(2), eNumber_Types.ent_integer) Then

                        Call WriteVip(asd(0), IIf(asd(1) > 0, True, False), asd(2))

                    Else
                        'No es numerico
                        Call ShowConsoleMsg("Valor incorrecto. Utilice /VIP NICKNAME@1 o 0@DIAS")
                    End If
                End If
            Else
                'Avisar que falta el parametro
                Call ShowConsoleMsg("ERROR: Para agregar se usa /VIP NICK@0@DIAS y para sacar /VIP NICK@1@0")
        ...
        Case "/ENCUESTA"
            ...
            If UserMap <> 1 Then WriteInquiry (ArgumentosRaw): Exit Sub
        ...
        Case "/DENUNCIAR"
            ...
            If MainTimer.Check(TimersIndex.SendDenunce) Then
                If notNullArguments Then
            ...
            Else
                ...
                Call ShowConsoleMsg("Faltan: " & CStr(MainTimer.GetTickInterval(TimersIndex.SendDenunce)) & " Segundos para que mandes otra denuncia.")
        ...
        Case "/FUNDARCLAN"
            ...
            Else
                Call ShowConsoleMsg("Para fundar un clan ten�s que ser nivel 35 y tener 90 skills en liderazgo.")
        ...
        Case "/CI"
            ...
            Else
                'Avisar que falta el parametro
                Call ShowConsoleMsg("Faltan par�metros. Utilice /ci OBJETO CANTIDAD.")
        ...
        Case "/DARPUNTOS"
            ...
            If notNullArguments Then
                ...
                If UBound(tmpArr) = 1 Then
                    If ValidNumber(tmpArr(1), eNumber_Types.ent_integer) Then
                        Call WriteSetPoints(tmpArr(0), tmpArr(1))
                    Else
                        'Faltan los parametros con el formato propio
                        Call ShowConsoleMsg("Formato incorrecto. Utilice /DARPUNTOS NICKNAME@PUNTOS.")
            ...
            Else
                'Avisar que falta el parametro
                Call ShowConsoleMsg("Faltan par�metros. Utilice /DARPUNTOS NICKNAME@PUNTOS.")
        ...
        Case "/CR"
            If notNullArguments And CantidadArgumentos >= 1 Then
                If ValidNumber(ArgumentosAll(0), eNumber_Types.ent_integer) Then
                    ...
                    Call WriteCountdown(ArgumentosAll(0), 0)

                    If CantidadArgumentos >= 2 Then    'puso el mapa?
                        If ValidNumber(ArgumentosAll(1), eNumber_Types.ent_integer) Then
                            Call WriteCountdown(ArgumentosAll(0), ArgumentosAll(1))
                        Else
                            'Argumentos de mas?
                            Call ShowConsoleMsg("Valor incorrecto. Utilice /CUENTAREGRESIVA VALOR MAPA(Opcional).")
                        End If
                    End If
                Else
                    'No es valido el 1
        ...
        Case "/SETINIVAR"
            ...
            Else
                Call ShowConsoleMsg("Par�metros incorrectos. Utilice /SETINIVAR LLAVE CLAVE VALOR")
        ...
        Case "/PROMEDIO"
                Call ShellExecute(frmMain.hwnd, "open", App.path & "/Calculadora.exe", "", "", 1)
        ...
        Case "/ENVIARMP"
            ...
            If CantidadArgumentos >= 2 Then
                Call WritePMSend(Argumentos2(0), Argumentos2(1))
            Else
                Call ShowConsoleMsg("Faltan par�metros. Utilice /ENVIARMP USUARIO MENSAJE.")

            End If

        Case "/LISTAMPS"

            If CantidadArgumentos = 0 Then    'Usuarios comunes, sin par�metros
                Call WritePMList
            ElseIf CantidadArgumentos = 1 Then    'GMs, con par�metros.
                Call WritePMListUser(ArgumentosAll(0), 0)
            ElseIf CantidadArgumentos = 2 Then    'GMs, con par�metros.

                If ValidNumber(ArgumentosAll(1), eNumber_Types.ent_Byte) Then
                    Call WritePMListUser(ArgumentosAll(0), ArgumentosAll(1))

                End If

            Else
                Call ShowConsoleMsg("Par�metros incorrectos. Utilice /LISTAMPS.")
        ...
        Case "/BORRARMPS"
            ...
            If CantidadArgumentos = 0 Then    'Usuarios comunes, sin par�metros
                Call WritePMDeleteList
            ElseIf CantidadArgumentos = 1 Then    'GMs, con par�metros.
                Call WritePMDeleteUser(ArgumentosAll(0), 0)
            ElseIf CantidadArgumentos = 2 Then    'GMs, con par�metros.

                If ValidNumber(ArgumentosAll(1), eNumber_Types.ent_Byte) Then
                    Call WritePMDeleteUser(ArgumentosAll(0), ArgumentosAll(1))

                End If

            Else
                Call ShowConsoleMsg("Par�metros incorrectos. Utilice /BORRARMPS.")

            End If

        Case "/CARA"
            Call WriteChangeHead
        ...
        Case "/LIMPIARMUNDO"
            ...
            Else
                Call ShowConsoleMsg("Comando Solo para administradores.")
        ...
        Case "/RETAR"
            ...
            If notNullArguments Then
                Call WriteAcceptReto(ArgumentosRaw)
            Else
                'Avisar que falta el parametro
                Call ShowConsoleMsg("Faltan par�metros. Utilice /RETAR NOMBRE.")
        ...
        Case "/CONTROL"
            ...
            If notNullArguments Then
                Call WriteRequieredControlUser(ArgumentosRaw)
            Else
                Call ShowConsoleMsg("Faltan parametros use /CONTROL NOMBRE")

            End If

        Case "/FOTO"

            If MainTimer.Check(TimersIndex.SendPhoto) Then
                If notNullArguments Then
                    Call writeRequestScreen(ArgumentosRaw)
                Else
                    Call ShowConsoleMsg("Faltan parametros use /FOTO NOMBRE")

                End If

            Else

                Call ShowConsoleMsg("Faltan: " & CStr(MainTimer.GetTickInterval(TimersIndex.SendPhoto)) & " Segundos para que saques otra foto.")
