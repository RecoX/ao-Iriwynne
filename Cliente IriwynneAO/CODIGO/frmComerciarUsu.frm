...
Begin VB.Form frmComerciarUsu 
   ...
   Begin RichTextLib.RichTextBox CommerceConsole 
      ...
      TextRTF         =   $"frmComerciarUsu.frx":2442A
   ...
   Begin VB.Image imgAceptar 
      Height          =   540
      Left            =   6600
      Picture         =   "frmComerciarUsu.frx":244A8
      Tag             =   "2"
      Top             =   8160
      Width           =   1680
   End
   Begin VB.Image imgCancelar 
      Height          =   540
      Left            =   480
      Picture         =   "frmComerciarUsu.frx":283EC
      Tag             =   "1"
      Top             =   4200
      Width           =   1680
   End
   Begin VB.Image imgRechazar 
      Height          =   540
      Left            =   8160
      Picture         =   "frmComerciarUsu.frx":2C330
      Tag             =   "2"
      Top             =   8160
      Width           =   1680
   End
   Begin VB.Image imgConfirmar 
      Height          =   540
      Left            =   7320
      Picture         =   "frmComerciarUsu.frx":30274
      Tag             =   "2"
      Top             =   3960
      Width           =   1680
   End
...
Private Sub Form_Load()
        ...
        Me.Picture = LoadPicture(DirInterfaces & "VentanaComercioUsuario.jpg")
...
Private Sub LoadButtons()
        ...
        Call cBotonAceptar.Initialize(imgAceptar, grhpath & "buttons/boton Aceptar.bmp", grhpath & "buttons/boton Aceptar 1.bmp", grhpath & "buttons/boton Aceptar 1.bmp", Me)
                                    
        Call cBotonConfirmar.Initialize(imgConfirmar, grhpath & "buttons/boton Confirmar.bmp", grhpath & "buttons/boton Confirmar 1.bmp", grhpath & "buttons/boton Confirmar 1.bmp", Me)
                                        
        Call cBotonRechazar.Initialize(imgRechazar, grhpath & "buttons/boton Rechazar.bmp", grhpath & "buttons/boton Rechazar 1.bmp", grhpath & "buttons/boton Rechazar 1.bmp", Me)
                                        
        Call cBotonCancelar.Initialize(imgCancelar, grhpath & "buttons/boton cancelar.bmp", grhpath & "buttons/boton cancelar 1.bmp", grhpath & "buttons/boton cancelar 1.bmp", Me)
